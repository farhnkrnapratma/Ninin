...
public class Menu extends World {
  ...
  public Menu() {
    ...
    private void prepare() {
        ...
        HelpButton.setLocation(267, 425);
        HelpButton.setLocation(280, 435);
        InfoButton InfoButton = new InfoButton();
        addObject(InfoButton, 329, 455);
        HelpButton.setLocation(282, 504);
        InfoButton.setLocation(480, 441);
        HelpButton.setLocation(266, 422);
        HelpButton.setLocation(291, 451);
        HelpButton.setLocation(282, 436);
        HelpButton.setLocation(280, 436);
        InfoButton.setLocation(456, 397);
        InfoButton.setLocation(239, 511);
        InfoButton.setLocation(282, 506);
        InfoButton.setLocation(302, 487);
        HelpButton.setLocation(299, 428);
        InfoButton.setLocation(281, 491);
        HelpButton.setLocation(297, 428);
        play.setLocation(271, 356);
        InfoButton.setLocation(265, 472);
        HelpButton.setLocation(284, 416);
        HelpButton.setLocation(283, 412);
        HelpButton.setLocation(297, 411);
        play.setLocation(311, 362);
        HelpButton.setLocation(315, 396);
        InfoButton.setLocation(311, 468);
        ...
        addObject(version, 387, 235);
        version.setLocation(51, 28);
        version.setLocation(54, 26);
        version.setLocation(69,27);
        version.setLocation(69,27);
        version.setLocation(68,26);
        version.setLocation(235,5);
        version.setLocation(490,21);
        version.setLocation(506,31);
    }
}
